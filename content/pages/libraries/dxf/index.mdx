...
title: 'DXF Export'
library: 'true'
description: 'Create DXF files to save geometry for loading into other programs. It works with triangle-based graphics including polygons, boxes, and spheres.'
---
