...
details: "Wiley. 384 Pages. Cubierta dura."
published: "2009-05"
...
El sitio web de Wiley website dice: "este libro ofrece una serie de procedimientos génericos que pueden funcionar como bloques constructores y te motiva a usarlos para experimentar, explorar y canalizar tus pensamientos, ideas y principios en soluciones potenciales. El libro cubre temas como formas estructuradas, geometría sólida, redes y bases de datos, computación física, procesamiento de imágenes, interfaces gráficas de usuario y mucho más."
