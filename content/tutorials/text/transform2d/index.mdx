...
<FixedImage center width={650} height={230}>
...
<FixedImage center width={650} height={81}>
...
<FixedImage center width={650} height={158}>
...
<FixedImage center width={650} height={86}>
...
<FixedImage center width={650} height={145}>
...
<FixedImage center width={650} height={168}>
...
The robot is modeled on [this drawing](http://www.openclipart.org/detail/5457), although it will not look as charming. First, we draw the robot so that its left and top side touch the *x* and *y* axes. That will allow us to use `translate()` to easily place the robot anywhere we want or to make multiple copies of the robot, as we did in the example of the houses.
...
<FixedImage center width={650} height={136}>
...
<FixedImage center width={650} height={52}>
...
<FixedImage center width={650} height={72}>
...
But what about finding the angle of a line that doesn't start from the origin, such as the line from (10, 37) to (48, 59)? No problem; it's the same as the angle of a line from (0, 0) to (48-10, 59-37). In general, to find the angle of the line from (*x*<sub>0</sub>, *y*<sub>0</sub>) to (*x*<sub>1</sub>, *y*<sub>1</sub>), calculate
