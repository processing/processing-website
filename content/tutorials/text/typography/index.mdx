...
This tutorial is the Typography chapter from [Processing: A Programming Handbook for Visual Designers and Artists, Second Edition](/books/#processing:-a-programming-handbook-for-visual-designers,-second-edition), published by MIT Press. &copy; 2014 MIT Press. If you see any errors or have comments, please [let us know](https://github.com/processing/processing-website/issues?state=open).
